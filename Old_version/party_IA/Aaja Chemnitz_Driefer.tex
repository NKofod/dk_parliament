...
\recipient{}{}
\name{Aaja Chemnitz}{Driefer}
\mobile{+45 3337 5454}
\email{aaja.larsenft.dk}
\position{Medlem af Folketinget{\enskip\cdotp\enskip}Inuit Ataqatigiit}
\address{}
\photo[circle,noedge,left]{"./party_IA/Aaja Chemnitz_Driefer_profile.jpg"}
\letterdate{\today}
\lettertitle{Aaja Chemnitz Driefer - Blå Bog}
\letteropening{}
\letterclosing{}
\letterenclosure[Attached]{Stemme Statistik}
\begin{document}
\makecvheader[R]
\makecvfooter{\today}{\lettertitle{Aaja Chemnitz Driefer - Blå Bog}}{}
\makelettertitle
\begin{cvletter}
